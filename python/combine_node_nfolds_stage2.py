...
path2csv_stage2=root_data+'stage2_sample_submission.csv'

df_test = pd.read_csv(path2csv_stage2)
...
path2nfolds_dsb=path2luna_nodes+'nfolds'+'_stage2_nodes.hdf5'
...
for foldnm in range(nb_folds):
    ...
    path2dsboutput=path2luna_nodes+'/fold'+str(foldnm)+'_stage2_nodes.hdf5'
